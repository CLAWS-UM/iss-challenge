...
namespace HoloToolkit.Unity
{
    ...
    public class MicStreamDemo : MonoBehaviour
    {
        ...
        /// </summary>
        public bool AutomaticallyStartStream = false;
        ...
        private void Update()
        {
            ...
            else if (Input.GetKeyDown(KeyCode.T))
            {
                ...
                {
                    Debug.Log("Audio recording does not exist at " + outputPath);
                }
                else
                {
                    SendRecording sender = new SendRecording(outputPath);
                    // sender.Send(string IPA, Int32 PortN);
                    Debug.Log("Audio recording sent to ");
                }
            }
